                        ...
                        <tbody>
                            {orders.map((order) => (
                                <tr key={order.id} className="admin-table-row">
                                    <td data-label="Order ID" style={{ padding: '1rem 1.5rem', fontWeight: '600' }}>{order.id}</td>
                                    <td data-label="Customer" style={{ padding: '1rem 1.5rem' }}>{order.customer}</td>
                                    <td data-label="Date" style={{ padding: '1rem 1.5rem', color: 'var(--text-muted)' }}>{order.date}</td>
                                    <td data-label="Total" style={{ padding: '1rem 1.5rem' }}>{order.total}</td>
