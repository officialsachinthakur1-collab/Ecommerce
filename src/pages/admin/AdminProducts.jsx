                                ...
                                <tr key={product.id || product._id} className="admin-table-row">
                                    <td data-label="Product Name" style={{ padding: '1rem 1.5rem', fontWeight: '600' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                            ...
                                            <div style={{ width: '40px', height: '40px', borderRadius: '4px', background: '#fff', overflow: 'hidden', border: '1px solid #ddd' }}>
                                                {product.image ? (
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                ...
                                {formData.image && (
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.5rem', background: '#1a1a1a', borderRadius: '8px' }}>
                                        <img src={formData.image} alt="Thumbnail Preview" style={{ width: '50px', height: '50px', objectFit: 'contain', borderRadius: '4px', background: '#fff', padding: '2px', border: '1px solid #ddd' }} />
                            ...
                            <div style={{ padding: '0.75rem', background: '#050505', border: '1px solid #333', color: 'white', borderRadius: '8px' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(60px, 1fr))', gap: '0.5rem' }}>
                                    {formData.images.map((img, idx) => (
                                        <div key={idx} style={{ position: 'relative', width: '60px', height: '60px', borderRadius: '4px', overflow: 'hidden', border: '1px solid #ddd', background: '#fff' }}>
